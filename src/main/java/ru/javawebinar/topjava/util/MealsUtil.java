...
public class MealsUtil {
    ...
    public static List<MealTo> getTo(Collection<Meal> meals, int caloriesPerDay, LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime) {
        return getFilteredTos(meals, caloriesPerDay, startDate, endDate, startTime, endTime);
    }
    ...
    public static List<MealTo> getFilteredTos(Collection<Meal> meals, int caloriesPerDay, LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime) {
        return filterByPredicate(meals, caloriesPerDay, meal -> DateTimeUtil.isBetweenHalfDate(meal.getDateTime(), startDate, endDate, startTime, endTime));
    }
